	...
	>
		<slot :it="it">
			<vc-img 
				...
				:class="imgClassName"
				fit="cover"
				class="vcm-upload-img-item__content"
				@click="handlePreview"
			/>
			<div v-else :class="imgClassName" class="vcm-upload-img-item__content">
...
export default {
	name: 'vcm-upload-picker-img-item',
	components: {
		'vc-icon': Icon,
		'vc-img': Img,
		'vc-spin': Spin,
...
@include block(vcm-upload-img-item) {
	position: relative;
	display: flex;
